...
<div class=" ">
<h1
           class="mb-4 htext text-center text-xl font-semibold text-gray-700 dark:text-gray-200"
         >
           Hiring <span class="text-purple-500" >Circle</span>

         </h1>
         <p class="mb-4  text-center fon text-gray-700 dark font-semibold font-weight-700  ">Sign in to continue</p>
