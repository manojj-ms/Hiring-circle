...
<div className="px-5 py-4 bg-white dark:bg-gray-900 relative shadow rounded-2xl max-h-screen h-40 rounded-b-3xl  max-w-lg">
    <div className="flex justify-between mb-4">
      ...
      <div className=" ml-2">
      <div className="text-gray-500 text-xs ml-1 ">Hi Charles,</div>
...
<div className="flex items-center justify-between min-h-screen bg-gray-200 text-gray-800">
    ...
    <div className="col-span-12 sm:col-span-6 md:col-span-3">
        <div className="flex flex-row bg-white shadow-sm rounded-xl p-3">
          ...
          <div className="flex flex-col flex-grow ml-4">
            <div className="text-sm mt-3 font-semibold text-gray-500"><Link to ='/employer/jobs'>Jobs</Link></div>
  ...
  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
          ...
          <div className="flex flex-col flex-grow ml-4">
            <div className="text-sm mt-3 font-semibold text-gray-500"><Link to='/employer/attendance'>Employees Attendance</Link></div>
  ...
  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 14l6-6m-5.5.5h.01m4.99 5h.01M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16l3.5-2 3.5 2 3.5-2 3.5 2zM10 8.5a.5.5 0 11-1 0 .5.5 0 011 0zm5 5a.5.5 0 11-1 0 .5.5 0 011 0z" />
          ...
          <div className="flex flex-col flex-grow ml-4">
            <div className="text-sm mt-3 font-semibold text-gray-500"><Link to='/employer/payroll'>Employees Payroll</Link></div>
  ...
  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
          ...
          <div className="flex flex-col flex-grow ml-4">
            <div className="text-sm mt-3 font-semibold text-gray-500"><Link to='/employer/leavehistory'>Employees Leave Request</Link></div>
  ...
  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
          ...
          <div className="flex flex-col flex-grow ml-4">
            <div className="text-sm mt-3 font-semibold text-gray-500"><Link to='/employer/review'>Reviews</Link></div>
